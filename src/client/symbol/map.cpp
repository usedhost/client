...
namespace selaura::detail {
	void register_memory() {
		...
		DEFINE_SIGNATURE("GuiData::displayClientMessage", platform::arm64, "40 55 53 56 57 41 56 48 8D AC 24 A0 FE FF FF 48 81 EC 60 02 00 00 48 8B 05 ? ? ? ? 48 33 C4 48 89 85 50 01 00 00 41");
	}
};

...
## 📄 License
Selaura Client currently falls under the [GPL-3.0 License](LICENSE). Feel free to use this code as a fork in your own project. Although not required, we would appreciate if you credited us as well. Thank you!
